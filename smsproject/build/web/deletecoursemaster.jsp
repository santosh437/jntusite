<%-- 
    Document   : deletecoursemaster.jsp
    Created on : 13 May, 2015, 11:06:14 AM
    Author     : SantoshKumar
--%>
...
<head>
	...
	<body class="no-skin" onload = "getUsers()">
		<%@include file="layouts/navbar.jsp" %>	
		<%@include file="layouts/menu.jsp" %>	

		<%@include file="layouts/deletecoursepart.jsp" %>
...
{ 
     // alert("Hello");
    var $select = $('#coursename');	       
    $.getJSON("./actions/deletecourse/getcourse.jsp",{id: $select.val(), ajax: 'true'}, function(j)
    {
        var options = '';
        //options+ ='<option>'+"'Select Course Name'" + j[i].co + '</option>'; 
        for (var i = 0; i < j.length; i++) 
        {
            options += '<option value = "' +j[i].co +'">'+ j[i].co + '</option>';
        }
        $("#coursename").html(options); 		
    });	
  };
</script>
<!-- Mirrored from responsiweb.com/themes/preview/ace/1.3.3/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Apr 2015 11:51:16 GMT -->
</html>
