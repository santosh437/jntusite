			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="row">
						...
						<div class="form-group">
                           	 	<button id="addcourse_Form1" style="margin-left:20px;" class="btn btn-sm btn-success" style="position:relative;" >ADD COURSE<i class="ace-icon fa fa-arrow-right icon-on-right bigger-110"></i>
                            	</button>
                       	</div>
						...
						<div class="col-xs-12" >
						      <div class="col-xs-12" >
								<form class="form-inline" id="Branch_Form" name="Branch_Form" role="form" >
								 ...
								 <div class="form-group" >
									    <button  class="btn btn-sm btn-success" id="addbranch_Form1" style="margin-top:20px;">ADD BRANCH<i class="ace-icon fa fa-arrow-right icon-on-right bigger-110"></i>
	                                 </button>
	                             </div>								
							</div>                                        
						</div>                                                                   
					...
					<div> <p> Semister Details </p> </div>
						...
						<div class="col-xs-12" >
						      <div class="col-xs-12" >
								...
								<button class="btn btn-sm btn-success" id="addsemester_Form1" style="margin-top:20px;">
	                  				  Add Semister
...
{
	$("#addcourse_Form1").click(function()
	{
...
$(document).ready(function()
{
	$("#addbranch_Form1").click(function()
	{
...
$(document).ready(function()
{
	$("#addsemester_Form1").click(function()
	{
		var year = $("#year").val();
